...
import { ArrowRight, Shield, Zap, Package, Star, CheckCircle } from 'lucide-react';
    ...
    <div className="pt-[88px]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-24 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-8 max-w-md">
              Hand-laid carbon fiber parts engineered for your exact vehicle. Guaranteed fitment, or your money back.
            </p>
            <div className="flex flex-wrap items-center gap-3 mb-10">
              <div className="flex items-center gap-1.5 text-green-400 text-sm font-medium">
                <CheckCircle size={15} /> Guaranteed Fitment
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { icon: Shield, title: 'Fit Guarantee', desc: 'Every part is verified to fit your exact year, make, model, and trim. Doesn\'t fit? Full refund.' },
      ...
      <section className="carbon-texture border-t dark:border-dark-border border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-md mx-auto">Enter your vehicle and get a personalized list of guaranteed-fit carbon parts in seconds.</p>
